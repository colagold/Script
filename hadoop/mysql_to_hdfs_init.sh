...
APP=gmall
sqoop=/root/install/sqoop/bin/sqoop
...
hadoop jar /root/install/hadoop/share/hadoop/common/hadoop-lzo-0.4.20.jar com.hadoop.compression.lzo.DistributedLzoIndexer /origin_data/$APP/db/$1/$do_date
}
